...
# creates a new node from the script, with NAME as the node name, and TEMPLATE as the template name inside of .build_utils/templates
new NAME TEMPLATE:
    @ ./.build_utils/create.py {{ NAME }} {{ TEMPLATE }}
